...
export const ARTWORKS: Artwork[] = [
  {
    ...
    secondaryImages: [
      encodeURI('/Antiga foto da Eva Construção no Playcenter.webp'),
      encodeURI('/Pessoas visitando a EVA by Fernando Quincas.webp'),
      encodeURI('/Por dentro da Boca da EVA by Fernando Quincas.webp')
    ],
  ...
  },
  {
    ...
    image: '/products/galinha-monte-verde-studio-green.webp',
    secondaryImages: [
  ...
  },
  {
    ...
    image: '/products/lobo-gigante-studio-green.webp',
    secondaryImages: [
  ...
  },
  {
    ...
    image: '/products/fonte-gigante-paulo-leardi-studio-green-casa.webp',
    secondaryImages: [
  ...
  },
  {
    ...
    image: '/products/gazebo-tenda-ferro-bamboo-principal.webp',
    secondaryImages: [
  ...
  },
  {
    ...
    image: '/products/lira-instrumento-musical-corda.webp',
    secondaryImages: [
      '/products/lira-backstage-01.webp',
      '/products/lira-traseira-backstage.webp',
      '/products/lira-bolsa-close.webp',
      '/products/lira-guia-musical.webp',
      '/products/lira-backstage-02.webp'
    ],
    availability: 'AVAILABLE',
