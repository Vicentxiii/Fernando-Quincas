...
export const BLOG_POSTS: BlogPost[] = [
  ...
  },
  {
    ...
    title: 'Iglu de Concreto 4×4m com Clarabóia — do Columbia em Campos do Jordão ao Jardim',
    subtitle: 'A história real do molde-mãe criado para a loja Columbia na temporada de inverno em Campos do Jordão — fibra de vidro com textura de neve, desmontável para remontagem — e como hoje o mesmo iglu 4×4m vira quarto, ateliê ou brinquedoteca em concreto, gesso, fibra ou bio-construção, com valor acessível, clarabóia e duração que atravessa estações. Cada projeto singular.',
    category: 'JARDIM',
    date: '2026-08-27',
    author: 'Fernando Quincas',
    authorRole: 'Escultor & Mestre Artesão',
    ...
    excerpt:
      'Iglu 4×4m por Fernando Quincas: do primeiro molde para a Columbia em Campos do Jordão (fibra de vidro textura neve, desmontável por temporadas) ao iglu de concreto que cria um cômodo novo no jardim sem obra infinita. De R$ 25.000 sem clarabóia a R$ 28.500 com clarabóia, a obra aguenta sol, chuva e tempo — e, a partir do mesmo molde, pode nascer em concreto, gesso, fibra ou bio-construção, cada projeto singular. Veja a origem e por que toda obra de Fernando Quincas é também escultura que dura.',
    coverImage: '/products/iglu-concreto-montanha.webp',
    tags: ['Fernando Quincas', 'Iglu de Concreto', 'Iglu Columbia', 'Campos do Jordão', 'Fibra de Vidro Textura Neve', 'Molde', '4x4', 'Clarabóia', 'Escultura', 'Obra', 'Jardim', 'Área Externa', 'Concreto Armado', 'Gesso', 'Bio-construção', 'Desmontável', 'R$ 25.000'],
    featured: true,
    blocks: [
      {
        type: 'paragraph',
        text: 'E se o seu jardim grande virasse casa? O Iglu 4×4m de Fernando Quincas nasceu exatamente para isso — mas não nasceu ontem, nem no jardim. Quando desenvolvi o primeiro iglu e os moldes para reprodução, fiz para uma empresa que tinha como objetivo uma loja de roupa de couro (Columbia) para a temporada de inverno em Campos do Jordão. Foi fabricado em fibra de vidro com textura de neve, para ser desmontado e montado novamente durante temporadas — cenografia habitável que virou arquitetura. Hoje, com 4×4 metros de base e clarabóia opcional para ventilação, esse mesmo molde-mãe gera o iglu em concreto armado que transforma área externa em cômodo novo, com valor acessível (R$ 25.000 sem clarabóia a R$ 28.500 com clarabóia instalada) e duração que aguenta tempo, sol e chuva. É uma obra de Fernando Quincas que transforma área externa em casa — e, como toda escultura do ateliê, foi feita para permanecer, mas agora com a inteligência de quem já foi desmontável.',
      },
      { type: 'heading', text: 'A origem: Columbia, Campos do Jordão e a fibra com textura de neve' },
      {
        type: 'paragraph',
        text: 'O primeiro iglu não foi para um jardim — foi para vitrine e experiência. A loja Columbia, de roupa de couro, precisava de um marco para a temporada de inverno em Campos do Jordão: algo que parecesse neve de verdade, que coubesse gente e que não virasse entulho em setembro. Fernando Quincas criou o iglu e o molde-mãe para reprodução em fibra de vidro com textura de neve — branco poroso, tátil, que reflete o frio sem gelar. A obra foi pensada para ser desmontada e montada novamente, durante temporadas: estrutura leve, encaixes e acabamento que sobrevivem a caminhão, serra e montagem repetida. O que era cenografia de temporada virou prova de método: o molde ficou, e com ele a possibilidade de repetir o iglu, igual e impecável, quantas vezes o projeto pedisse.',
      },
      {
        type: 'list',
        items: [
          'Columbia — Campos do Jordão (inverno): primeiro iglu e moldes criados sob encomenda para loja de roupa de couro na temporada de inverno — obra cenográfica que virou arquitetura.',
          'Fibra de vidro com textura de neve: pele do iglu original — leve, branca, tátil, fotografável como neve, mas resistente para montar e desmontar.',
          'Desmontável para remontagem: projetado para ser desmontado e montado novamente durante temporadas — vestir a loja no inverno e guardar no verão, sem perder forma.',
          'Molde-mãe guardado no ateliê: a matriz que permite reprodução fiel — base do processo que hoje gera o iglu em concreto e outros materiais.',
        ],
      },
      { type: 'heading', text: 'Iglu não é barraca: é cômodo novo com alma de escultura' },
      {
        type: 'paragraph',
        text: 'No ateliê de Fernando Quincas, um iglu não é improviso — é obra. O Iglu 4×4m tem casca que não teme intempérie, porta em arco que convida e, opcional, clarabóia que traz luz zenital e ventilação cruzada. Sem clarabóia, a obra já resolve como decoração monumental para grandes jardins; com clarabóia, vira cômodo fechado — quarto de hóspedes, ateliê, brinquedoteca, cinema ou refúgio de leitura. Cada iglu é pensado como escultura habitável: por fora, a curva escultural organiza o jardim; por dentro, o vazio acolhe. Na versão atual mais pedida, o concreto armado dá peso e inércia térmica para permanência; na versão de origem, a fibra com textura de neve dava leveza e mobilidade para temporada. É a mesma escultura de Fernando Quincas que cria casa onde antes só havia grama — só muda o material do processo singular.',
      },
      {
        type: 'image',
        ...
        caption: 'Na montanha: o Iglu 4×4m de Fernando Quincas — a obra em seu habitat, herdeira do primeiro iglu em fibra textura neve para a Columbia em Campos do Jordão.',
      },
      {
        type: 'image',
        src: '/products/iglu-concreto-medidas.webp',
        alt: 'Iglu de Concreto 4×4m medidas por Fernando Quincas - desenho técnico com cotas',
        caption: 'Medidas do Iglu 4×4m — a obra 4×4 com cotas, gerada a partir do molde-mãe original.',
      },
      { type: 'heading', text: 'Um molde, diversos materiais: concreto, gesso, fibra e bio-construção — cada projeto singular' },
      {
        type: 'paragraph',
        text: 'A partir do molde-mãe, posso desenvolver em diversos materiais — concreto, gesso, fibra e bio-construção. Cada projeto segue um processo singular. Não é trocar só a matéria: é recalcular peso, isolamento, logística e acabamento para o lugar. Quer permanência e inércia térmica para sítio e Airbnb? Concreto armado com impermeabilização. Quer leveza e remontagem a cada temporada como na Columbia? Fibra de vidro com textura de neve, desmontável. Quer interior aconchegante e acústica? Gesso. Quer pegada ecológica e respiro? Bio-construção. O molde garante a forma icônica 4×4 — o projeto singular garante que a obra funcione no seu terreno, no seu clima e no seu uso. Por isso, todo iglu de Fernando Quincas é sob encomenda e orientado pelo ateliê, do material ao ponto no jardim.',
      },
      {
        type: 'list',
        items: [
          'Concreto armado: permanência e peso — ideal para cômodo fixo que aguenta sol, chuva e tempo por décadas (versão atual R$ 25.000 a R$ 28.500).',
          'Fibra de vidro textura neve: leveza e desmontável — herdeiro direto do iglu Columbia / Campos do Jordão, para temporadas e cenografia.',
          'Gesso e bio-construção: conforto e sustentabilidade — interiores mais quentes e respiro ecológico, definidos no processo singular.',
          'Cada projeto singular: material, montagem (fixo ou desmontável), acabamento e clarabóia decididos com Fernando Quincas para o seu terreno.',
        ],
      },
      { type: 'heading', text: 'Por que o iglu aguenta sol, chuva e tempo?' },
      {
        type: 'paragraph',
        text: 'Porque nasce de molde-mãe testado em temporada e recebe acabamento do ateliê de Fernando Quincas — não é lona, não é madeira que empena. Na versão concreto, a obra recebe impermeabilização e acabamento que resistem a sol, chuva, sereno e vento, estação após estação; na versão fibra, a mesma resina que segurou invernos em Campos do Jordão segue com selante para externo. A clarabóia, quando incluída (R$ 28.500 com clarabóia na versão concreto), garante ventilação e evita condensação — por isso, o iglu de Fernando Quincas não mofa, não infiltra e não pede manutenção heroica, seja qual for o material do processo singular. É uma escultura que, mesmo sendo obra de jardim, tem a mesma lógica de toda obra monumental do ateliê: feita para durar, e para ser remontada quando o projeto pede.',
      },
      {
        type: 'list',
        items: [
          'Concreto armado (ou fibra/gesso/bio): estrutura da obra — escolha do processo singular que segura sol e chuva, com duração que atravessa anos.',
          'Impermeabilização: pele da obra — protege a escultura de Fernando Quincas contra infiltração, da fibra textura neve ao concreto.',
          'Clarabóia opcional (+ R$ 3.500 na versão concreto): luz e ventilação — a obra de R$ 25.000 vira R$ 28.500 com clarabóia instalada, ideal para cômodo fechado e Airbnb.',
          'Acabamento do ateliê Fernando Quincas: detalhe final da obra 4×4 que garante charme mesmo sob tempo — e que nasceu para ser desmontado e remontado sem perder neve.',
        ],
      },
      {
        type: 'image',
        ...
        caption: 'No jardim: o Iglu 4×4m de Fernando Quincas — escultura que vira cômodo novo, hoje em concreto, herdeira da fibra textura neve da Columbia.',
      },
      { type: 'heading', text: 'Onde o iglu brilha: grandes jardins e áreas externas de casa' },
      {
        type: 'paragraph',
        text: 'A graça do Iglu 4×4m de Fernando Quincas está no lugar certo. Em grandes jardins, a obra cria ponto focal — decoração monumental que organiza o verde e convida a entrar. Em áreas externas de casa — quintal, sítio, chácara, pousada — o iglu vira extensão da casa: quarto extra, home office, sala de jogos (games room) ou biblioteca (library) como mostram as plantas do ateliê. Cada uso revela uma face da escultura — e confirma que toda obra do ateliê nasce para ser vivida, não só vista. Em Campos do Jordão, o iglu em fibra virou loja; no sítio, em concreto, vira pousada; em gesso ou bio-construção, vira ateliê acolhedor. E, como toda obra garden, funciona tão bem em montanha quanto em praia, em cidade ou campo — basta escolher, no processo singular, o material certo.',
      },
      {
        type: 'list',
        items: [
          'Grandes jardins: decoração monumental — a obra 4×4 de Fernando Quincas cria cômodo novo sem obra infinita.',
          'Áreas externas de casa: quintal, sítio, chácara — a escultura vira quarto, ateliê ou brinquedoteca com valor acessível.',
          'Games room e Library: plantas do ateliê mostram o iglu 4×4 como sala de jogos e biblioteca — obra que se adapta, em qualquer material do molde.',
          'Montanha e cidade: do concreto ao gesso, da fibra textura neve à bio-construção — obra de Fernando Quincas para qualquer clima, fixa ou desmontável.',
        ],
      },
      {
        type: 'image',
        ...
        caption: 'Escala humana: pessoa ao lado do Iglu 4×4m — a obra em tamanho real, replicável do molde-mãe Columbia.',
      },
      {
        type: 'image',
        src: '/products/iglu-concreto-montanha.webp',
        alt: 'Iglu de Concreto 4×4m na montanha - escultura de Fernando Quincas para área externa',
        caption: 'Na montanha: o Iglu 4×4m de Fernando Quincas — obra que aguenta tempo, sol e chuva, como já provou nos invernos de Campos do Jordão.',
      },
      {
        type: 'image',
      ...
      {
        type: 'quote',
        text: 'Quando desenvolvi o primeiro iglu e os moldes para reprodução, fiz para uma loja de roupa de couro (Columbia) para a temporada de inverno em Campos do Jordão. Foi em fibra de vidro com textura de neve, para ser desmontado e montado novamente durante temporadas. A partir do molde, posso desenvolver em diversos materiais — concreto, gesso, fibra, bio-construção. Cada projeto segue um processo singular.',
        attribution: 'Fernando Quincas',
      },
      {
        type: 'quote',
      ...
      {
        type: 'paragraph',
        text: 'Cada Iglu 4×4m do ateliê de Fernando Quincas é obra sob encomenda e cada projeto segue um processo singular. Na versão concreto armado — a mais pedida para jardim e Airbnb — sem clarabóia a obra custa R$ 25.000; com clarabóia para ventilação instalada, R$ 28.500 (R$ 28.000 cada levando em quantidade). O valor acessível, para uma obra 4×4 que cria um cômodo novo e dura décadas sob sol e chuva, explica por que o iglu é tão procurado. Quer repetir a lógica original da Columbia, leve e desmontável para temporadas? O mesmo molde-mãe gera o iglu em fibra de vidro com textura de neve. Prefere aconchego ou pegada ecológica? Gesso ou bio-construção, com acabamento definido no processo singular com Fernando Quincas. Como toda escultura do ateliê, o iglu leva assinatura e orientação — da escolha do material e do ponto no jardim à instalação da clarabóia.',
      },
      {
        type: 'list',
        items: [
          'R$ 25.000 sem clarabóia — versão concreto armado, decoração monumental 4×4 para grandes jardins, já com impermeabilização.',
          'R$ 28.500 com clarabóia instalada (R$ 28.000 cada em quantidade) — cômodo novo ventilado, com luz zenital, pronto para morar e para Airbnb.',
          'Outros materiais sob consulta: fibra textura neve desmontável (origem Columbia / Campos do Jordão), gesso e bio-construção — cada projeto singular com valor e logística próprios.',
          'Instalação orientada pelo ateliê: cada obra 4×4 de Fernando Quincas é acompanhada — do molde ao material, do concreto à clarabóia, fixo ou desmontável.',
          'Encontrar na loja: Iglu de Concreto 4×4 com Clarabóia em Garden (/loja/iglu-de-concreto-4x4-com-claraboia) — obra de Fernando Quincas. Fale com o ateliê para orçar em gesso, fibra ou bio-construção.',
        ],
      },
      {
        type: 'paragraph',
        text: 'Hoje, o Iglu 4×4m vive na loja do ateliê de Fernando Quincas na categoria Garden — encontre em /loja/iglu-de-concreto-4x4-com-claraboia de R$ 25.000 a R$ 28.500 na versão concreto. Como toda obra do ateliê, cada iglu é produzido sob encomenda por Fernando Quincas a partir do molde-mãe da Columbia. Se você busca um iglu de concreto, um iglu em fibra textura neve desmontável, uma escultura para grandes jardins, uma obra em gesso ou bio-construção que crie cômodo novo com valor acessível e que aguente sol, chuva e tempo — cada projeto singular — esta obra é a escolha. A escultura 4×4 de Fernando Quincas, nascida para o inverno de Campos do Jordão e hoje para o seu jardim, está pronta para transformar sua área externa em casa.',
      },
    ],
  },
  {
