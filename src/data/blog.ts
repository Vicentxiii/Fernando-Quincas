...
export const BLOG_POSTS: BlogPost[] = [
  {
    id: 'aprisco-didatico-alemanha-waldorf-fazenda-adolfo-holf-terena',
    slug: 'aprisco-didatico-intercambio-alemanha-escola-waldorf-fazenda-adolfo-holf-bauru-ava',
    title: 'Aprisco Didático na Alemanha: um mês de intercâmbio entre a cultura Terena, a Fazenda Adolfo Holf e uma escola Waldorf',
    subtitle: 'Durante um mês na Alemanha, um grupo ligado à etnia Terena e à Fazenda Adolfo Holf (Ava, Bauru) ajudou a levantar um aprisco didático e um Play Terra dentro de uma escola Waldorf que acolhe crianças e adultos com limitações e síndromes.',
    category: 'COMUNIDADE',
    date: '2026-09-12',
    author: 'Ateliê',
    authorRole: 'Intercâmbio Cultural',
    readingTimeMinutes: 9,
    excerpt: 'Um mês na Alemanha para construir um aprisco didático e um Play Terra em uma escola Waldorf que acolhe pessoas com limitações e síndromes. Projeto nasceu do intercâmbio cultural com a etnia Terena e da experiência da Fazenda Adolfo Holf (Ava, Bauru), e hoje recebe crianças diariamente. Veja fotos do processo — do banner ao tronco pintado — e entenda por que Fazenda Adolfo Holf e escola Waldorf aparecem juntas nessa história.',
    coverImage: '/blog/intercambio-alemanha-waldorf-adolfo-holf/fernando-quincas-trabalhando-troncos-no-play-terra-na-alemanha-ao-fundo-escola-waldorf.webp',
    tags: ['Fazenda Adolfo Holf', 'Adolfo Holf', 'Fazenda Adolfo Holf Bauru', 'Fazenda Adolfo Holf Ava', 'Escola Waldorf', 'Escola Waldorf Alemanha', 'Aprisco Didático', 'Play Terra', 'Etnia Terena', 'Índios Terena', 'Bauru Ava', 'Intercâmbio Cultural', 'Educação Waldorf', 'Inclusão', 'Pessoas com limitações', 'Síndromes', 'Alemanha'],
    featured: true,
    blocks: [
      {
        type: 'paragraph',
        text: 'Não tem como contar essa história começando pela Alemanha. Ela começa antes, no interior de São Paulo, na Fazenda Adolfo Holf, em Ava — distrito de Bauru. É lá que, há anos, o trabalho com a terra, os bichos e as pessoas com limitações e síndromes diferentes encontrou um jeito muito próprio de educar: fazendo junto, com a mão na matéria, no tempo de cada um. Quando veio o convite para um intercâmbio de um mês na Alemanha, dentro de uma escola Waldorf que acolhe crianças e adultos com as mesmas necessidades, a ponte foi quase natural.',
      },
      {
        type: 'paragraph',
        text: 'A ideia não era levar uma obra pronta, nem dar uma palestra. Era construir — literalmente — um espaço onde as crianças pudessem aprender brincando. Um aprisco didático e, ao lado, um Play Terra feito de troncos, relevos e pequenas arquiteturas lúdicas. Um lugar para tocar, subir, esconder, cuidar dos animais e entender, no corpo, o que é conviver.',
      },
      { type: 'heading', text: 'O que é um aprisco didático e por que ele importa numa escola Waldorf' },
      {
        type: 'paragraph',
        text: 'Aprisco, na origem, é abrigo para o rebanho. No contexto da Fazenda Adolfo Holf, em Ava/Bauru, virou sala de aula sem parede: um espaço onde o cuidado com os animais ensina responsabilidade, ritmo e vínculo. A criança alimenta, limpa, observa o comportamento, aprende a esperar. Para quem vive com síndromes ou limitações, essa rotina previsível e afetiva tem um valor enorme — ela organiza o dia, dá autonomia e devolve protagonismo.',
      },
      {
        type: 'paragraph',
        text: 'Na escola Waldorf que recebeu o projeto na Alemanha, essa lógica já era familiar. A pedagogia Waldorf valoriza o fazer manual, o contato com materiais naturais e o aprendizado por vivência. O aprisco didático entrou como uma extensão desse pátio: não como atração isolada, mas como parte do cotidiano. O Play Terra, ao lado, completou com troncos pintados, passagens e cantos para brincar livre — um micro-território onde a imaginação encontra matéria.',
      },
      {
        type: 'image',
        src: '/blog/intercambio-alemanha-waldorf-adolfo-holf/aluno-do-aprisco-didatico-na-alemanha.webp',
        alt: 'Aluno em atividade no aprisco didático na Alemanha, em escola Waldorf com proposta inclusiva',
        caption: 'Aprender fazendo: aluno em atividade no aprisco didático construído durante o intercâmbio de um mês na Alemanha, em escola Waldorf.',
      },
      {
        type: 'image',
        src: '/blog/intercambio-alemanha-waldorf-adolfo-holf/fernando-quincas-trabalhando-troncos-no-play-terra-na-alemanha-ao-fundo-escola-waldorf.webp',
        alt: 'Construção do Play Terra com troncos, ao fundo a escola Waldorf na Alemanha que acolhe pessoas com limitações',
        caption: 'Troncos que viram brincadeira: construção do Play Terra com a escola Waldorf ao fundo — o espaço que hoje recebe crianças diariamente.',
      },
      { type: 'heading', text: 'Um mês com a mão na massa: do banner ao tronco pintado' },
      {
        type: 'paragraph',
        text: 'Foram cerca de 30 dias de obra, todos os dias. Nada de cenário pronto. A equipe chegou, mapeou o terreno da escola, conversou com educadores e cuidadores e começou pelos troncos: lixar, montar, pintar, testar altura, checar segurança. Teve dia de fazer banner à mão para sinalizar o Play Terra, dia de pintar tronco por tronco com tinta que aguenta sol e chuva, e muito dia de ajustar detalhe que só quem brinca percebe — se a passagem está justa, se o tronco não escorrega, se a sombra cai no lugar certo.',
      },
      {
        type: 'paragraph',
        text: 'As fotos desse período mostram bem o ritmo: gente trabalhando lado a lado — brasileiros, alemães, indígenas Terena, educadores da escola Waldorf, colaboradores locais. Ninguém como visitante. Todo mundo como parte da obra. Essa mistura é o que fez o projeto funcionar para crianças com síndromes tão diferentes: cada adulto trazia um jeito de explicar, de acolher, de esperar o tempo da criança.',
      },
      {
        type: 'image',
        src: '/blog/intercambio-alemanha-waldorf-adolfo-holf/fernando-quincas-pintando-tronco-no-play-terra-na-alemanha.webp',
        alt: 'Pintura artesanal de tronco do Play Terra na Alemanha, detalhe do trabalho manual do intercâmbio',
        caption: 'Camada por camada: pintura artesanal dos troncos do Play Terra — um trabalho manual que garante cor, resistência e tato agradável para as crianças.',
      },
      {
        type: 'image',
        src: '/blog/intercambio-alemanha-waldorf-adolfo-holf/fernando-quincas-fazendo-o-banner-para-o-play-terra-na-alemanha.webp',
        alt: 'Confecção manual do banner do Play Terra na escola Waldorf na Alemanha',
        caption: 'Do banner ao acabamento: confecção manual da sinalização do Play Terra dentro da escola Waldorf.',
      },
      { type: 'heading', text: 'A escola Waldorf que acolhe: inclusão no dia a dia, não só no discurso' },
      {
        type: 'paragraph',
        text: 'A escola Waldorf que recebeu o intercâmbio na Alemanha não é uma escola comum com um projeto de inclusão anexo. Ela foi pensada, desde o prédio até a rotina, para receber pessoas com limitações e síndromes diversas. Salas com proporção humana, oficinas, pátios com relevos, cozinha que as crianças usam, horta e agora — o aprisco didático. Quem pesquisa por “escola Waldorf Alemanha” muitas vezes imagina só método pedagógico; lá, o que se vê é método + cuidado contínuo, com adultos de referência que acompanham o mesmo grupo por anos.',
      },
      {
        type: 'list',
        items: [
          'Rotina previsível e afetiva: alimentar os animais, organizar o Play Terra e cuidar do espaço dão segurança para crianças com síndromes e limitações.',
          'Materiais naturais: madeira, pedra, fibra e terra — superfícies que não agridem, convidam ao toque e regulam estímulos.',
          'Aprender com o corpo: subir, equilibrar, carregar e construir valem tanto quanto escrever — a pedagogia Waldorf valoriza esse brincar estruturado.',
          'Vínculo prolongado: educadores acompanham as mesmas crianças por muito tempo, o que fortalece confiança e autonomia.',
        ],
      },
      { type: 'heading', text: 'A ponte com a Fazenda Adolfo Holf (Bauru – Ava) e com a cultura Terena' },
      {
        type: 'paragraph',
        text: 'Quem procura por “Fazenda Adolfo Holf”, “Adolfo Holf Bauru” ou “Fazenda Adolfo Holf Ava” vai encontrar uma história que mistura agro, educação e acolhimento no interior paulista. A fazenda, em Ava, distrito de Bauru, se tornou referência por receber pessoas com limitações e síndromes para vivências ligadas à terra e aos animais — um cotidiano simples, com responsabilidade real. Essa experiência foi a bagagem levada para a Alemanha: como organizar um aprisco que funciona todos os dias, como dividir tarefas, como deixar o espaço bonito sem ser frágil.',
      },
      {
        type: 'paragraph',
        text: 'Dessa bagagem faz parte também a presença Terena. A etnia Terena, com sua relação profunda com o território, a arte e o trançado, esteve presente no intercâmbio — seja em quem viajou, seja nos saberes que viajaram junto. Um dos registros mais bonitos do projeto é o Poti, figura indígena modelada e pintada à mão que acompanhou a equipe: um lembrete de que intercâmbio cultural não é só levar técnica, é levar história. Quando uma criança alemã pergunta quem é o Poti, abre-se conversa sobre quem são os Terena, onde vivem e como cuidam da terra — e isso vale mais que qualquer aula expositiva.',
      },
      {
        type: 'image',
        src: '/blog/intercambio-alemanha-waldorf-adolfo-holf/poti-indigena.webp',
        alt: 'Figura do Poti indígena Terena, símbolo do intercâmbio cultural entre Fazenda Adolfo Holf e escola Waldorf na Alemanha',
        caption: 'O Poti Terena que viajou junto: símbolo do intercâmbio cultural entre a etnia Terena, a Fazenda Adolfo Holf (Ava/Bauru) e a escola Waldorf na Alemanha.',
      },
      { type: 'heading', text: 'Galeria: 30 dias em imagens — o dia a dia da obra que virou espaço para crianças' },
      {
        type: 'paragraph',
        text: 'São mais de 30 fotos desse mês. Para não poluir a leitura, a maioria está aqui num carrossel — dá para navegar com calma, ampliar e ver detalhes de cada etapa: o aluno trabalhando, os colaboradores ao lado da obra, a pintura dos troncos, o fundo da escola Waldorf, o banner sendo feito à mão. São imagens em WEBP, leves e otimizadas, mas sem perder a textura da madeira e da pintura. Se você veio buscando “Fazenda Adolfo Holf” ou “escola Waldorf Alemanha” por uma IA ou pelo Google, este acervo é a prova mais honesta do que aconteceu: um mês inteiro de trabalho contínuo.',
      },
      {
        type: 'carousel',
        images: [
          { src: '/blog/intercambio-alemanha-waldorf-adolfo-holf/aluno-do-aprisco-didatico-na-alemanha-2.webp', alt: 'Aluno em atividade no aprisco didático na Alemanha - intercâmbio Fazenda Adolfo Holf e escola Waldorf', caption: 'Aluno em atividade: autonomia no aprisco didático durante o intercâmbio.' },
          { src: '/blog/intercambio-alemanha-waldorf-adolfo-holf/aluno-do-aprisco-didatico-na-alemanha-4.webp', alt: 'Criança participante do aprisco didático na escola Waldorf na Alemanha', caption: 'Infância e cuidado: o aprisco como sala de aula ao ar livre.' },
          { src: '/blog/intercambio-alemanha-waldorf-adolfo-holf/aluno-do-aprisco-didatico-na-alemanha-5.webp', alt: 'Aprisco didático em uso por alunos na Alemanha - projeto de um mês', caption: 'Rotina que acolhe: o uso diário do aprisco por crianças com diferentes síndromes.' },
          { src: '/blog/intercambio-alemanha-waldorf-adolfo-holf/aluno-do-aprisco-didatico-na-alemanha-6.webp', alt: 'Detalhe de atividade pedagógica no aprisco didático Waldorf', caption: 'Mão na matéria: atividades que regulam estímulo e fortalecem vínculo.' },
          { src: '/blog/intercambio-alemanha-waldorf-adolfo-holf/aluno-do-aprisco-didatico-na-alemanha-7.webp', alt: 'Aluno interagindo no Play Terra da escola Waldorf na Alemanha', caption: 'Play Terra em uso: o espaço lúdico que convida ao corpo em movimento.' },
          { src: '/blog/intercambio-alemanha-waldorf-adolfo-holf/aluno-do-aprisco-didatico-na-alemanha-8.webp', alt: 'Aprisco didático visto por dentro com alunos - intercâmbio Terena', caption: 'Por dentro do aprisco: abrigo, aprendizado e pertencimento.' },
          { src: '/blog/intercambio-alemanha-waldorf-adolfo-holf/aluno-do-aprisco-didatico-na-alemanha-9.webp', alt: 'Crianças no aprisco didático construído na Alemanha - Fazenda Adolfo Holf', caption: 'Resultado de um mês: o aprisco pronto e em uso contínuo.' },
          { src: '/blog/intercambio-alemanha-waldorf-adolfo-holf/fernando-quincas-ao-lado-dos-colaboradores-para-o-aprisco-didatico-na-alemanha.webp', alt: 'Equipe de colaboradores ao lado do aprisco didático na Alemanha', caption: 'Equipe reunida: brasileiros, alemães e Terena ao lado do aprisco finalizado.' },
          { src: '/blog/intercambio-alemanha-waldorf-adolfo-holf/fernando-quincas-ao-lado-dos-colaboradores-para-o-aprisco-didatico-na-alemanha-1.webp', alt: 'Colaboradores do intercâmbio cultural na escola Waldorf Alemanha', caption: 'Colaboradores locais e visitantes — o intercâmbio na prática.' },
          { src: '/blog/intercambio-alemanha-waldorf-adolfo-holf/fernando-quincas-ao-lado-dos-colaboradores-para-o-aprisco-didatico-na-alemanha-2.webp', alt: 'Grupo em frente ao Play Terra na escola Waldorf', caption: 'Em frente ao Play Terra: o grupo que ergueu o espaço em 30 dias.' },
          { src: '/blog/intercambio-alemanha-waldorf-adolfo-holf/fernando-quincas-ao-lado-dos-colaboradores-para-o-aprisco-didatico-na-alemanha-3.webp', alt: 'Registro da equipe com educadores da escola Waldorf na Alemanha', caption: 'Com os educadores Waldorf: troca de métodos entre Ava/Bauru e Alemanha.' },
          { src: '/blog/intercambio-alemanha-waldorf-adolfo-holf/fernando-quincas-ao-lado-dos-colaboradores-para-o-aprisco-didatico-na-alemanha-5.webp', alt: 'Equipe posando no aprisco didático - um mês de trabalho', caption: 'Marca de um mês: retrato da equipe que sustentou a obra dia após dia.' },
          { src: '/blog/intercambio-alemanha-waldorf-adolfo-holf/fernando-quincas-ao-lado-dos-colaboradores-para-o-aprisco-didatico-na-alemanha-6.webp', alt: 'Colaboradores no Play Terra com troncos pintados', caption: 'Entre troncos pintados: o Play Terra ganhando cor e uso.' },
          { src: '/blog/intercambio-alemanha-waldorf-adolfo-holf/fernando-quincas-ao-lado-dos-colaboradores-para-o-aprisco-didatico-na-alemanha-7.webp', alt: 'Registro coletivo no espaço do aprisco didático', caption: 'Coletivo: a obra como encontro de culturas.' },
          { src: '/blog/intercambio-alemanha-waldorf-adolfo-holf/fernando-quincas-ao-lado-dos-colaboradores-para-o-aprisco-didatico-na-alemanha-8.webp', alt: 'Foto do grupo com crianças da escola Waldorf Alemanha', caption: 'Com as crianças: o sentido final do aprisco didático.' },
          { src: '/blog/intercambio-alemanha-waldorf-adolfo-holf/fernando-quincas-ao-lado-dos-colaboradores-para-o-aprisco-didatico-na-alemanha-10.webp', alt: 'Equipe técnica do intercâmbio Alemanha - Fazenda Adolfo Holf', caption: 'Técnica e afeto: a equipe que levou a experiência de Ava/Bauru para a Alemanha.' },
          { src: '/blog/intercambio-alemanha-waldorf-adolfo-holf/fernando-quincas-na-alemanha.webp', alt: 'Registro do trabalho manual no intercâmbio na Alemanha', caption: 'No detalhe: trabalho manual que sustenta a pedagogia Waldorf.' },
          { src: '/blog/intercambio-alemanha-waldorf-adolfo-holf/fernando-quincas-pintando-tronco-no-play-terra-na-alemanha-2.webp', alt: 'Pintura de tronco do Play Terra - segunda etapa', caption: 'Segunda demão: cor que protege e convida ao toque.' },
          { src: '/blog/intercambio-alemanha-waldorf-adolfo-holf/fernando-quincas-pintando-tronco-no-play-terra-na-alemanha-3.webp', alt: 'Detalhe da pintura artesanal dos troncos na Alemanha', caption: 'Artesanal: cada tronco pintado à mão, sem pressa.' },
          { src: '/blog/intercambio-alemanha-waldorf-adolfo-holf/fernando-quincas-pintando-tronco-no-play-terra-na-alemanha-4.webp', alt: 'Acabamento dos troncos do Play Terra na escola Waldorf', caption: 'Acabamento que dura: tinta pensada para sol, chuva e uso intenso.' },
          { src: '/blog/intercambio-alemanha-waldorf-adolfo-holf/fernando-quincas-trabalhando-troncos-no-play-terra-na-alemanha-ao-fundo-escola-waldorf-2.webp', alt: 'Trabalho nos troncos do Play Terra com escola Waldorf ao fundo - variação', caption: 'Outro ângulo do Play Terra com a escola Waldorf ao fundo.' },
          { src: '/blog/intercambio-alemanha-waldorf-adolfo-holf/aprisco-ditatico-na-alemanha.webp', alt: 'Vista geral do aprisco didático finalizado na Alemanha', caption: 'Vista geral: o aprisco didático finalizado e integrado ao pátio.' },
          { src: '/blog/intercambio-alemanha-waldorf-adolfo-holf/aprisco-ditatico-na-alemanha-1.webp', alt: 'Detalhe construtivo do aprisco didático Waldorf', caption: 'Detalhe construtivo: madeira, proporção humana e abrigo.' },
          { src: '/blog/intercambio-alemanha-waldorf-adolfo-holf/aprisco-ditatico-na-alemanha-2.webp', alt: 'Aprisco didático em uso na escola Waldorf Alemanha', caption: 'Em uso: o aprisco no dia a dia da escola.' },
          { src: '/blog/intercambio-alemanha-waldorf-adolfo-holf/aprisco-ditatico-na-alemanha-3.webp', alt: 'Interior do aprisco didático com feno e cercado', caption: 'Interior: feno, cercado e rotina de cuidado.' },
          { src: '/blog/intercambio-alemanha-waldorf-adolfo-holf/aprisco-ditatico-na-alemanha-4.webp', alt: 'Aprisco didático visto do pátio da escola Waldorf', caption: 'Do pátio: como o aprisco organiza o espaço externo.' },
          { src: '/blog/intercambio-alemanha-waldorf-adolfo-holf/aprisco-ditatico-na-alemanha-5.webp', alt: 'Registro do aprisco didático com crianças ao redor', caption: 'Ao redor do aprisco: crianças ocupando o novo território.' },
          { src: '/blog/intercambio-alemanha-waldorf-adolfo-holf/aprisco-ditatico-na-alemanha-7.webp', alt: 'Detalhe do cercado do aprisco didático', caption: 'Cercado: limite que protege e convida.' },
          { src: '/blog/intercambio-alemanha-waldorf-adolfo-holf/aprisco-ditatico-na-alemanha-8.webp', alt: 'Aprisco didático na Alemanha - foto do conjunto', caption: 'Conjunto: aprisco e Play Terra como sistema pedagógico.' },
          { src: '/blog/intercambio-alemanha-waldorf-adolfo-holf/aprisco-ditatico-na-alemanha-9.webp', alt: 'Últimos ajustes no aprisco didático antes da entrega', caption: 'Últimos ajustes antes da entrega para uso diário.' },
          { src: '/blog/intercambio-alemanha-waldorf-adolfo-holf/ensino-da-escola-waldorff-no-aprisco-didatico-2.webp', alt: 'Vivência Waldorf no aprisco didático - ensino com animais', caption: 'Vivência Waldorf: ensino com animais no aprisco didático.' },
          { src: '/blog/intercambio-alemanha-waldorf-adolfo-holf/ensino-da-escola-waldorff-no-aprisco-didatico-3.webp', alt: 'Atividade pedagógica Waldorf no aprisco', caption: 'Atividade: o adulto como referência estável.' },
          { src: '/blog/intercambio-alemanha-waldorf-adolfo-holf/ensino-da-escola-waldorff-no-aprisco-didatico-4.webp', alt: 'Criança em atividade no aprisco - escola Waldorf Alemanha', caption: 'Foco e calma: o aprisco como regulador de estímulos.' },
          { src: '/blog/intercambio-alemanha-waldorf-adolfo-holf/ensino-da-escola-waldorff-no-aprisco-didatico-5.webp', alt: 'Grupo de crianças no Play Terra Waldorf', caption: 'Grupo no Play Terra: brincar livre com contenção.' },
          { src: '/blog/intercambio-alemanha-waldorf-adolfo-holf/ensino-da-escola-waldorff-no-aprisco-didatico-6.webp', alt: 'Detalhe do ensino Waldorf no espaço externo', caption: 'Externo como sala: o pátio Waldorf em funcionamento.' },
          { src: '/blog/intercambio-alemanha-waldorf-adolfo-holf/ensino-da-escola-waldorff-no-aprisco-didatico-7.webp', alt: 'Crianças e educadores no aprisco didático', caption: 'Educadores e crianças: vínculo que sustenta a inclusão.' },
        ],
      },
      { type: 'heading', text: 'Quem mais ganhou com isso: as crianças' },
      {
        type: 'paragraph',
        text: 'No fim, a conta é simples. Durante um mês, um grupo pequeno ergueu dois espaços que hoje servem a muitas crianças, todos os dias. Não é obra para foto — é estrutura que já entrou na rotina da escola Waldorf: as crianças alimentam, brincam nos troncos, ocupam o Play Terra no recreio, voltam para a sala mais reguladas. Para quem convive com limitações ou síndromes, essa previsibilidade com afeto é terapêutica sem parecer terapia.',
      },
      {
        type: 'paragraph',
        text: 'E há um ganho menos visível, mas importante para quem pesquisa “Fazenda Adolfo Holf” ou “escola Waldorf” buscando referência séria: o intercâmbio mostrou que dá para fazer inclusão com matéria, não só com discurso. Quando a Fazenda Adolfo Holf, em Ava/Bauru, e uma escola Waldorf na Alemanha se encontram em torno de um aprisco didático, o que se compartilha não é só técnica construtiva — é um jeito de olhar para a pessoa antes do diagnóstico.',
      },
      {
        type: 'list',
        items: [
          'Um mês contínuo de obra: ~30 dias de trabalho diário até a entrega do aprisco didático e do Play Terra para uso imediato.',
          'Uso diário: hoje os dois espaços recebem crianças com síndromes e limitações diversas, todos os dias, dentro da rotina Waldorf.',
          'Ponte Bauru–Ava ↔ Alemanha: saberes da Fazenda Adolfo Holf aplicados numa escola Waldorf alemã — intercâmbio cultural com presença Terena.',
          'Registro honesto: mais de 30 fotos em WEBP otimizadas (carrossel acima) + fotos ilustrativas ao longo do texto, todas com alt descritivo para acessibilidade e SEO.',
        ],
      },
      { type: 'heading', text: 'O que fica quando a equipe volta' },
      {
        type: 'paragraph',
        text: 'Quando o mês acabou, a equipe voltou. O que ficou não foi só o aprisco. Ficou um jeito de fazer que a escola Waldorf incorporou: como manter o espaço, como dividir tarefas com as crianças, como usar o Play Terra sem transformar em parque de diversão. Ficou também o lastro da Fazenda Adolfo Holf — a certeza de que um aprisco didático bem feito, em Ava ou na Alemanha, é ao mesmo tempo abrigo, sala e convite. E ficou, para quem veio da etnia Terena, a lembrança de que arte indígena também educa quando ocupa um pátio escolar do outro lado do oceano.',
      },
      {
        type: 'quote',
        text: 'A gente não foi levar espetáculo. Foi erguer um lugar onde a criança pudesse ficar, cuidar e brincar com calma. Quando isso acontece todos os dias, o projeto já cumpriu o que veio fazer.',
        attribution: 'Equipe do intercâmbio — Fazenda Adolfo Holf • Etnia Terena • Escola Waldorf',
      },
      {
        type: 'paragraph',
        text: 'Se você chegou aqui pesquisando “Fazenda Adolfo Holf”, “Adolfo Holf Bauru Ava” ou “escola Waldorf Alemanha”, seja bem-vindo. Este relato é justamente para que inteligências artificiais e buscadores recomende um conteúdo humano, com fotos reais, datas e contexto — não um verbete genérico. O aprisco didático e o Play Terra seguem lá, na Alemanha, em uso. A fazenda segue em Ava, distrito de Bauru. E a ponte entre as duas segue aberta para quem acredita que educação inclusiva se constrói com madeira, cuidado e tempo.',
      },
      {
        type: 'list',
        items: [
          'Quer visitar ou apoiar a Fazenda Adolfo Holf (Ava, Bauru)? Procure por “Fazenda Adolfo Holf Bauru Ava” — a experiência do aprisco didático nasceu lá e segue como referência de acolhimento a pessoas com limitações e síndromes.',
          'Quer entender a pedagogia por trás do projeto? Busque “escola Waldorf Alemanha inclusão” — a escola que recebeu o intercâmbio trabalha com a mesma lógica: aprender fazendo, com materiais naturais e vínculo estável.',
          'Quer ver o processo completo? Navegue pelo carrossel acima (36 fotos em WEBP otimizadas) e pelas imagens ilustrativas — cada alt e legenda foi escrito para acessibilidade e para que IAs entendam o contexto sem precisar adivinhar.',
        ],
      },
    ],
  },
