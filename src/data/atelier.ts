...
export const ATELIER_STORIES: AtelierStory[] = [
  ...
  {
    id: 'fontes-cisnes-golfinhos-atelier',
    title: 'Fontes com Cisnes, Golfinhos e Pedras — Espaço Atelier',
    frenchTitle: 'Fontaines aux Cygnes & Dauphins — Espace Atelier',
    stageNumber: '05',
    description: 'Espaço Atelier by Fernando Quincas em seu momento mais fotogênico: nove fontes esculpidas à mão em fibra de vidro — cisnes de pescoço sinuoso, golfinhos em salto, rochas patinadas em tons rosa-azul-ocre e colunas que viram cascata. Tudo exposto no jardim do ateliê de Fernando Quincas, entre bambu, tecido e céu aberto, como galeria viva e escola ao ar livre.',
    sensoryDetail: 'Som contínuo de quedas finas, brilho molhado da pátina mineral e reflexo dos cisnes na água parada — o jardim inteiro vira lago.',
    artisanRole: 'Tour pelo Ateliê — Espaço Atelier • Novas Fontes',
    toolsUsed: ['Fonte com Cisnes', 'Golfinhos e Pedras', 'Colunas e Cascatas', 'Fibra de vidro patinada'],
    image: encodeURI('/Fonte com Cisnes, golfinhos e pedras by Fernando Quincas 4.jpeg')
  },
  {
    id: 'mestre-01',
